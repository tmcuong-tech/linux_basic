cài đặt python và pytharm

- cài đặt pyhton bằng terminal
	sudo apt-get install python3

cài đặt bằng ứng dụng
	pycharm
		cài đặt trực tiếp trên web jetbrains
		chọn phiên bản pycharm community (free)
		download file.gz
		vào thư mục chứa file.gz đã tải về
		giải nén file.gz
		vào thư mục bin
		click phải chuột vào file pycharm.sh -> run a program
